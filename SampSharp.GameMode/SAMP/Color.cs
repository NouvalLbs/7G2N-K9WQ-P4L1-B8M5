...
public struct Color : IEquatable<Color>
{
    ...
    {
        0x000000FF, 0xF5F5F5FF, 0x2A77A1FF, 0x840410FF, 0x263739FF, 0x86446EFF, 0xD78E10FF, 0x4C75B7FF, 0xBDBEC6FF, 0x5E7072FF, 0x46597AFF, 0x656A79FF,
        0x5D7E8DFF, 0x58595AFF, 0xD6DAD6FF, 0x9CA1A3FF, 0x335F3FFF, 0x730E1AFF, 0x7B0A2AFF, 0x9F9D94FF, 0x3B4E78FF, 0x732E3EFF, 0x691E3BFF, 0x96918CFF,
        0x515459FF, 0x3F3E45FF, 0xA5A9A7FF, 0x635C5AFF, 0x3D4A68FF, 0x979592FF, 0x421F21FF, 0x5F272BFF, 0x8494ABFF, 0x767B7CFF, 0x646464FF, 0x5A5752FF,
        0x252527FF, 0x2D3A35FF, 0x93A396FF, 0x6D7A88FF, 0x221918FF, 0x6F675FFF, 0x7C1C2AFF, 0x5F0A15FF, 0x193826FF, 0x5D1B20FF, 0x9D9872FF, 0x7A7560FF,
        0x989586FF, 0xADB0B0FF, 0x848988FF, 0x304F45FF, 0x4D6268FF, 0x162248FF, 0x272F4BFF, 0x7D6256FF, 0x9EA4ABFF, 0x9C8D71FF, 0x6D1822FF, 0x4E6881FF,
        0x9C9C98FF, 0x917347FF, 0x661C26FF, 0x949D9FFF, 0xA4A7A5FF, 0x8E8C46FF, 0x341A1EFF, 0x6A7A8CFF, 0xAAAD8EFF, 0xAB988FFF, 0x851F2EFF, 0x6F8297FF,
        0x585853FF, 0x9AA790FF, 0x601A23FF, 0x20202CFF, 0xA4A096FF, 0xAA9D84FF, 0x78222BFF, 0x0E316DFF, 0x722A3FFF, 0x7B715EFF, 0x741D28FF, 0x1E2E32FF,
        0x4D322FFF, 0x7C1B44FF, 0x2E5B20FF, 0x395A83FF, 0x6D2837FF, 0xA7A28FFF, 0xAFB1B1FF, 0x364155FF, 0x6D6C6EFF, 0x0F6A89FF, 0x204B6BFF, 0x2B3E57FF,
        0x9B9F9DFF, 0x6C8495FF, 0x4D8495FF, 0xAE9B7FFF, 0x406C8FFF, 0x1F253BFF, 0xAB9276FF, 0x134573FF, 0x96816CFF, 0x64686AFF, 0x105082FF, 0xA19983FF,
        0x385694FF, 0x525661FF, 0x7F6956FF, 0x8C929AFF, 0x596E87FF, 0x473532FF, 0x44624FFF, 0x730A27FF, 0x223457FF, 0x640D1BFF, 0xA3ADC6FF, 0x695853FF,
    ...
    {
        [new Color(0xF0, 0xF8, 0xFF, 0xFF)] = "AliceBlue",
        [new Color(0xFA, 0xEB, 0xD7, 0xFF)] = "AntiqueWhite",
        [new Color(0x00, 0xFF, 0xFF, 0xFF)] = "Aqua",
        [new Color(0x7F, 0xFF, 0xD4, 0xFF)] = "Aquamarine",
        [new Color(0xF0, 0xFF, 0xFF, 0xFF)] = "Azure",
        [new Color(0xF5, 0xF5, 0xDC, 0xFF)] = "Beige",
        [new Color(0xFF, 0xE4, 0xC4, 0xFF)] = "Bisque",
        [new Color(0x00, 0x00, 0x00, 0xFF)] = "Black",
        [new Color(0xFF, 0xEB, 0xCD, 0xFF)] = "BlanchedAlmond",
        [new Color(0x00, 0x00, 0xFF, 0xFF)] = "Blue",
        [new Color(0x8A, 0x2B, 0xE2, 0xFF)] = "BlueViolet",
        [new Color(0xA5, 0x2A, 0x2A, 0xFF)] = "Brown",
        [new Color(0xDE, 0xB8, 0x87, 0xFF)] = "BurlyWood",
        [new Color(0x5F, 0x9E, 0xA0, 0xFF)] = "CadetBlue",
        [new Color(0x7F, 0xFF, 0x00, 0xFF)] = "Chartreuse",
        [new Color(0xD2, 0x69, 0x1E, 0xFF)] = "Chocolate",
        [new Color(0xFF, 0x7F, 0x50, 0xFF)] = "Coral",
        [new Color(0x64, 0x95, 0xED, 0xFF)] = "CornflowerBlue",
        [new Color(0xFF, 0xF8, 0xDC, 0xFF)] = "Cornsilk",
        [new Color(0xDC, 0x14, 0x3C, 0xFF)] = "Crimson",
        [new Color(0x00, 0xFF, 0xFF, 0xFF)] = "Cyan",
        [new Color(0x00, 0x00, 0x8B, 0xFF)] = "DarkBlue",
        [new Color(0x00, 0x8B, 0x8B, 0xFF)] = "DarkCyan",
        [new Color(0xB8, 0x86, 0x0B, 0xFF)] = "DarkGoldenrod",
        [new Color(0xA9, 0xA9, 0xA9, 0xFF)] = "DarkGray",
        [new Color(0x00, 0x64, 0x00, 0xFF)] = "DarkGreen",
        [new Color(0xBD, 0xB7, 0x6B, 0xFF)] = "DarkKhaki",
        [new Color(0x8B, 0x00, 0x8B, 0xFF)] = "DarkMagenta",
        [new Color(0x55, 0x6B, 0x2F, 0xFF)] = "DarkOliveGreen",
        [new Color(0xFF, 0x8C, 0x00, 0xFF)] = "DarkOrange",
        [new Color(0x99, 0x32, 0xCC, 0xFF)] = "DarkOrchid",
        [new Color(0x8B, 0x00, 0x00, 0xFF)] = "DarkRed",
        [new Color(0xE9, 0x96, 0x7A, 0xFF)] = "DarkSalmon",
        [new Color(0x8F, 0xBC, 0x8F, 0xFF)] = "DarkSeaGreen",
        [new Color(0x48, 0x3D, 0x8B, 0xFF)] = "DarkSlateBlue",
        [new Color(0x2F, 0x4F, 0x4F, 0xFF)] = "DarkSlateGray",
        [new Color(0x00, 0xCE, 0xD1, 0xFF)] = "DarkTurquoise",
        [new Color(0x94, 0x00, 0xD3, 0xFF)] = "DarkViolet",
        [new Color(0xFF, 0x14, 0x93, 0xFF)] = "DeepPink",
        [new Color(0x00, 0xBF, 0xFF, 0xFF)] = "DeepSkyBlue",
        [new Color(0x69, 0x69, 0x69, 0xFF)] = "DimGray",
        [new Color(0x1E, 0x90, 0xFF, 0xFF)] = "DodgerBlue",
        [new Color(0xB2, 0x22, 0x22, 0xFF)] = "Firebrick",
        [new Color(0xFF, 0xFA, 0xF0, 0xFF)] = "FloralWhite",
        [new Color(0x22, 0x8B, 0x22, 0xFF)] = "ForestGreen",
        [new Color(0xFF, 0x00, 0xFF, 0xFF)] = "Fuchsia",
        [new Color(0xDC, 0xDC, 0xDC, 0xFF)] = "Gainsboro",
        [new Color(0xF8, 0xF8, 0xFF, 0xFF)] = "GhostWhite",
        [new Color(0xFF, 0xD7, 0x00, 0xFF)] = "Gold",
        [new Color(0xDA, 0xA5, 0x20, 0xFF)] = "Goldenrod",
        [new Color(0x80, 0x80, 0x80, 0xFF)] = "Gray",
        [new Color(0x00, 0x80, 0x00, 0xFF)] = "Green",
        [new Color(0xAD, 0xFF, 0x2F, 0xFF)] = "GreenYellow",
        [new Color(0xF0, 0xFF, 0xF0, 0xFF)] = "Honeydew",
        [new Color(0xFF, 0x69, 0xB4, 0xFF)] = "HotPink",
        [new Color(0xCD, 0x5C, 0x5C, 0xFF)] = "IndianRed",
        [new Color(0x4B, 0x00, 0x82, 0xFF)] = "Indigo",
        [new Color(0xFF, 0xFF, 0xF0, 0xFF)] = "Ivory",
        [new Color(0xF0, 0xE6, 0x8C, 0xFF)] = "Khaki",
        [new Color(0xE6, 0xE6, 0xFA, 0xFF)] = "Lavender",
        [new Color(0xFF, 0xF0, 0xF5, 0xFF)] = "LavenderBlush",
        [new Color(0x7C, 0xFC, 0x00, 0xFF)] = "LawnGreen",
        [new Color(0xFF, 0xFA, 0xCD, 0xFF)] = "LemonChiffon",
        [new Color(0xAD, 0xD8, 0xE6, 0xFF)] = "LightBlue",
        [new Color(0xF0, 0x80, 0x80, 0xFF)] = "LightCoral",
        [new Color(0xE0, 0xFF, 0xFF, 0xFF)] = "LightCyan",
        [new Color(0xFA, 0xFA, 0xD2, 0xFF)] = "LightGoldenrodYellow",
        [new Color(0xD3, 0xD3, 0xD3, 0xFF)] = "LightGray",
        [new Color(0x90, 0xEE, 0x90, 0xFF)] = "LightGreen",
        [new Color(0xFF, 0xB6, 0xC1, 0xFF)] = "LightPink",
        [new Color(0xFF, 0xA0, 0x7A, 0xFF)] = "LightSalmon",
        [new Color(0x20, 0xB2, 0xAA, 0xFF)] = "LightSeaGreen",
        [new Color(0x87, 0xCE, 0xFA, 0xFF)] = "LightSkyBlue",
        [new Color(0x77, 0x88, 0x99, 0xFF)] = "LightSlateGray",
        [new Color(0xB0, 0xC4, 0xDE, 0xFF)] = "LightSteelBlue",
        [new Color(0xFF, 0xFF, 0xE0, 0xFF)] = "LightYellow",
        [new Color(0x00, 0xFF, 0x00, 0xFF)] = "Lime",
        [new Color(0x32, 0xCD, 0x32, 0xFF)] = "LimeGreen",
        [new Color(0xFA, 0xF0, 0xE6, 0xFF)] = "Linen",
        [new Color(0xFF, 0x00, 0xFF, 0xFF)] = "Magenta",
        [new Color(0x80, 0x00, 0x00, 0xFF)] = "Maroon",
        [new Color(0x66, 0xCD, 0xAA, 0xFF)] = "MediumAquamarine",
        [new Color(0x00, 0x00, 0xCD, 0xFF)] = "MediumBlue",
        [new Color(0xBA, 0x55, 0xD3, 0xFF)] = "MediumOrchid",
        [new Color(0x93, 0x70, 0xDB, 0xFF)] = "MediumPurple",
        [new Color(0x3C, 0xB3, 0x71, 0xFF)] = "MediumSeaGreen",
        [new Color(0x7B, 0x68, 0xEE, 0xFF)] = "MediumSlateBlue",
        [new Color(0x00, 0xFA, 0x9A, 0xFF)] = "MediumSpringGreen",
        [new Color(0x48, 0xD1, 0xCC, 0xFF)] = "MediumTurquoise",
        [new Color(0xC7, 0x15, 0x85, 0xFF)] = "MediumVioletRed",
        [new Color(0x19, 0x19, 0x70, 0xFF)] = "MidnightBlue",
        [new Color(0xF5, 0xFF, 0xFA, 0xFF)] = "MintCream",
        [new Color(0xFF, 0xE4, 0xE1, 0xFF)] = "MistyRose",
        [new Color(0xFF, 0xE4, 0xB5, 0xFF)] = "Moccasin",
        [new Color(0xFF, 0xDE, 0xAD, 0xFF)] = "NavajoWhite",
        [new Color(0x00, 0x00, 0x80, 0xFF)] = "Navy",
        [new Color(0xFD, 0xF5, 0xE6, 0xFF)] = "OldLace",
        [new Color(0x80, 0x80, 0x00, 0xFF)] = "Olive",
        [new Color(0x6B, 0x8E, 0x23, 0xFF)] = "OliveDrab",
        [new Color(0xFF, 0xA5, 0x00, 0xFF)] = "Orange",
        [new Color(0xFF, 0x45, 0x00, 0xFF)] = "OrangeRed",
        [new Color(0xDA, 0x70, 0xD6, 0xFF)] = "Orchid",
        [new Color(0xEE, 0xE8, 0xAA, 0xFF)] = "PaleGoldenrod",
        [new Color(0x98, 0xFB, 0x98, 0xFF)] = "PaleGreen",
        [new Color(0xAF, 0xEE, 0xEE, 0xFF)] = "PaleTurquoise",
        [new Color(0xDB, 0x70, 0x93, 0xFF)] = "PaleVioletRed",
        [new Color(0xFF, 0xEF, 0xD5, 0xFF)] = "PapayaWhip",
        [new Color(0xFF, 0xDA, 0xB9, 0xFF)] = "PeachPuff",
        [new Color(0xCD, 0x85, 0x3F, 0xFF)] = "Peru",
        [new Color(0xFF, 0xC0, 0xCB, 0xFF)] = "Pink",
        [new Color(0xDD, 0xA0, 0xDD, 0xFF)] = "Plum",
        [new Color(0xB0, 0xE0, 0xE6, 0xFF)] = "PowderBlue",
        [new Color(0x80, 0x00, 0x80, 0xFF)] = "Purple",
        [new Color(0xFF, 0x00, 0x00, 0xFF)] = "Red",
        [new Color(0xBC, 0x8F, 0x8F, 0xFF)] = "RosyBrown",
        [new Color(0x41, 0x69, 0xE1, 0xFF)] = "RoyalBlue",
        [new Color(0x8B, 0x45, 0x13, 0xFF)] = "SaddleBrown",
        [new Color(0xFA, 0x80, 0x72, 0xFF)] = "Salmon",
        [new Color(0xF4, 0xA4, 0x60, 0xFF)] = "SandyBrown",
        [new Color(0x2E, 0x8B, 0x57, 0xFF)] = "SeaGreen",
        [new Color(0xFF, 0xF5, 0xEE, 0xFF)] = "SeaShell",
        [new Color(0xA0, 0x52, 0x2D, 0xFF)] = "Sienna",
        [new Color(0xC0, 0xC0, 0xC0, 0xFF)] = "Silver",
        [new Color(0x87, 0xCE, 0xEB, 0xFF)] = "SkyBlue",
        [new Color(0x6A, 0x5A, 0xCD, 0xFF)] = "SlateBlue",
        [new Color(0x70, 0x80, 0x90, 0xFF)] = "SlateGray",
        [new Color(0xFF, 0xFA, 0xFA, 0xFF)] = "Snow",
        [new Color(0x00, 0xFF, 0x7F, 0xFF)] = "SpringGreen",
        [new Color(0x46, 0x82, 0xB4, 0xFF)] = "SteelBlue",
        [new Color(0xD2, 0xB4, 0x8C, 0xFF)] = "Tan",
        [new Color(0x00, 0x80, 0x80, 0xFF)] = "Teal",
        [new Color(0xD8, 0xBF, 0xD8, 0xFF)] = "Thistle",
        [new Color(0xFF, 0x63, 0x47, 0xFF)] = "Tomato",
        [new Color(0xff, 0xff, 0xff, 0x00)] = "Transparent",
        [new Color(0x40, 0xE0, 0xD0, 0xFF)] = "Turquoise",
        [new Color(0xEE, 0x82, 0xEE, 0xFF)] = "Violet",
        [new Color(0xF5, 0xDE, 0xB3, 0xFF)] = "Wheat",
        [new Color(0xFF, 0xFF, 0xFF, 0xFF)] = "White",
        [new Color(0xF5, 0xF5, 0xF5, 0xFF)] = "WhiteSmoke",
    ...
    /// <summary>Gets the red value of this Color.</summary>
    public byte R { get; set; }

    /// <summary>Gets the green value of this Color.</summary>
    public byte G { get; set; }

    /// <summary>Gets the blue value of this Color.</summary>
    public byte B { get; set; }

    /// <summary>Gets the alpha value of this Color.</summary>
    ...
    {
        var hexLength = colorFormat == ColorFormat.RGB
            ? 6
            : 8;
    ...
    /// <summary>Returns the name of this color or <c>null</c> if this color does not have a known name.</summary>
    /// <returns>The name of this color or <c>null</c> if this color does not have a known name.</returns>
    public string GetName()
    {
        ColorNames.TryGetValue(this, out var result);
        return result;
    }

    /// <summary>Returns an Color representation of the specified VehicleColor.</summary>
